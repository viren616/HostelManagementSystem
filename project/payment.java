...
public static  String x="",y="",f1;
   ...
   payment()
      {     
        ...
        jl.setFont(new Font("Courier",4,18));
        jp1.add(jl);
        jl.setForeground(Color.white);
        jl1=new JLabel("PASSWORD");
        jl1.setBounds(380,230,190,30);           
        jl1.setFont(new Font("Courier",4,18));
        jp1.add(jl1);
        jl1.setForeground(Color.white);
       jl2=new JLabel("PAYMENT FORM");
           jp1.add(jl2);
           jl2.setBounds(400,10,600,50);
...
{       
          ...
          new payupdate();
            jf2.setText("");  
              ...
              JOptionPane.showMessageDialog(jf,"UnAuthorised"); 
                 jf2.setText("");                
                      }  catch(Exception e){System.out.println(e);} 
...
showPassword.addActionListener(new ActionListener()
     ...
     jb2.addActionListener(new ActionListener()
      ...
      ImageIcon ic1 = new ImageIcon("bc.jpg");
        ...
        ImageIcon ic = new ImageIcon("p2.png");
